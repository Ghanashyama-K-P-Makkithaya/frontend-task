...
import Title from '../Abouthim/Title.jsx'
...
function Abouther() {
  return (
    ...
    <div className='w-full bg-center bg-no-repeat bg-cover bg-blend-darken bg-half-black' style={{backgroundImage: `url(src/assets/profile-her.jpg)`, height:"65vh"}}>
    
        <Title heading={"DIANNE ANNA"}/>
    </div>
    ...
    <Footer img='src/assets/footer-image-her.jpg'/>
    </>
  )
}
